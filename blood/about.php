...
<div class="col-12" style="height: 350px">
	...
	<img class="myFrontPic col-12" src="images/img10.jpg" style="height: 350px;">
</div>
	<div style="margin: 0; padding: 2% 5% 2% 5%; text-align: center; overflow: auto;">
		...
		<h3><i>"Blood donation is the gift of life—one small act that makes an immeasurable difference."</i> </h3>
		</blockquote></div><br>
		<p style="color: rgb(116, 118, 122); text-align: left;">We are student of ATMECE. This portal had been developed to bring technology to help humanity . We tried to use best contemporary technologies in delivering a promising web portal to bring together all the blood donors in MYSORE, thereby fulfilling every blood request in our city.</p>
		...
		<div class="col-12" style="padding: 0 30% 0 30%;">
			<div class="polaroid">
				<img class="col-12" src="./images/imga.jpg" alt="MYSORE">
				<div class="container">
					<p>ATMECE MYSORE</p>
				</div>
			</div>
